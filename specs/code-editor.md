...
- [x] Modificar `src/components/ui/code-editor.tsx` — implementar textarea overlay com grid CSS
...
- [x] Modificar `src/app/home-editor.tsx` — integrar hooks, adicionar seletor de linguagem
- [x] Criar componente de seletor de linguagem (dropdown no actions bar ou no header do editor)
